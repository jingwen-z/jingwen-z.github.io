...
amount. During 6.5 years, the average price per m2 increases by 37%
(11.5/8.4 - 1), especially from the year 2017, the average price per m2
increases by nearly 26% (11.5/9.1 - 1). Moreover, the transaction amount arrives
...
of COVID-19 pandemic, the transaction amount dropped 50% in April 2020, then it
reverted after the first confinement ended.
